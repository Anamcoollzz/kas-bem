    ...
    <div class="col-md-12">
           ...
           <div class="panel-body">
            <div class="table-responsive">
                    ...
                    <tbody>
                       ...
                       while ($data=$sql->fetch_assoc()) {
                           ...
                           <tr class="odd gradeX">
                            ...
                            <td>
                               <a id="edit_masuk" data-toggle="modal" data-target="#edit" data-id="<?php echo $data['kode']; ?>" data-tgl="<?php echo  $data['tgl']; ?>"  data-ket="<?php echo $data['keterangan']; ?>"  data-jml="<?php echo    $data['jumlah'];?>" class="btn btn-info"><i class="fa fa-edit"></i> Ubah</a>
               ...
               <tr>
                   ...
                   <td align="right" style="font-size: 15px;"><b><?php echo "Rp." .number_format($total) ; ?>,-</b></td>
               </tr>
           </table>
       </div>
       ...
       <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        ...
        if (isset($_POST['simpan'])) {
          ...
          $sql = $koneksi->query("insert into kas (kode, keterangan, tgl, jumlah, jenis, keluar) values('$kode', '$keterangan', '$tanggal', '$jumlah', 'Masuk', 0)");
...
<div class="modal fade" id="edit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    if (isset($_POST['edit'])) {
       ...
       $sql = $koneksi->query("update kas set keterangan='$ket', tgl='$tgl', jumlah='$jml' where kode='$id'");
...
<div class="modal fade" id="lap" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
             <form role="form" method="POST" action="laporan/laporan_kas_masuk_pdf.php" target="blank" >
               ...
               <div class="modal-footer">
                ...
                <a href="./laporan/laporan_kas_masuk_pdf.php" class="btn btn-default" target="blank" style="margin-top: 8px; margin-left: 5px;"><i class="fa fa-print"></i> Cetak Semua</a>
